...
var mode = Part.DANCE; // current mode
...
var lEye = {type:'i', value:1};
var rEye = {type:'i', value:2};
...
var lLaser = {type:'i', value:1};
var rLaser = {type:'i', value:2};
...
var rightLaserMaterial = new THREE.ShaderMaterial({
    ...
    new THREE.SourceLoader().load(LaserShaderFiles, function(shaders) {
      leftLaserMaterial.vertexShader = shaders['glsl//lasers.vs.glsl'];
      leftLaserMaterial.fragmentShader = shaders['glsl//lasers.fs.glsl'];

      rightLaserMaterial.vertexShader = shaders['glsl//lasers.vs.glsl'];
      rightLaserMaterial.fragmentShader = shaders['glsl//lasers.fs.glsl'];
    })

    var laserGeometry = new THREE.CylinderGeometry(0.02, 0.02, 2, 5);
...
loadOBJ(Part.DANCE, 'obj/armadillo.obj', dancingArmadilloMaterial, 1, 0, 0, 0, 0, 0, 0); // Armadillo
...
function update() {
  ...
  dancingArmadilloMaterial.uniforms['time'].value = time;
}

...
var mode = Part.CROSS// current mode
...
var crossMaterial = new THREE.ShaderMaterial({
  uniforms: {
      lightColorUniform: lightColorUniform,
      ambientColorUniform: ambientColorUniform,
      lightDirectionUniform: lightDirectionUniform,
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
  ...
  crossMaterial.fragmentShader = shaders['glsl/cross.fs.glsl'];
  crossMaterial.vertexShader = shaders['glsl/cross.vs.glsl'];
  ...
  crossMaterial.needsUpdate = true;
...
loadOBJ(Part.ANISOTROPIC,'obj/bunny.obj', anisotropicMaterial,0.5, 4.5, 0.2, 2, 0, 0, 0);
loadOBJ(Part.ANISOTROPIC,'obj/male.obj', anisotropicMaterial, 0.03, 2, 0, -2, 0, 0, 0);
loadOBJ(Part.ANISOTROPIC,'obj/armadillo.obj', anisotropicMaterial, 1, -4, 1, 2, 0, -2, 0);
loadOBJ(Part.ANISOTROPIC,'obj/car.obj', anisotropicMaterial, 0.05, -5, 0, -4, -Math.PI/2,0,Math.PI/3);
...
// TODO: load your objects here
loadOBJ(Part.TOON,'obj/bunny.obj', toonMaterial,0.5, 4.5, 0.2, 2, 0, 0, 0);
loadOBJ(Part.TOON,'obj/male.obj', toonMaterial, 0.03, 2, 0, -2, 0, 0, 0);
loadOBJ(Part.TOON,'obj/armadillo.obj', toonMaterial, 1, -4, 1, 2, 0, -2, 0);
loadOBJ(Part.TOON,'obj/car.obj', toonMaterial, 0.05, -5, 0, -4, -Math.PI/2,0,Math.PI/3);
...
// TODO: load your objects here
 loadOBJ(Part.CROSS,'obj/bunny.obj', goochMaterial,0.5, 4.5, 0.2, 2, 0, 0, 0);
 loadOBJ(Part.CROSS,'obj/male.obj', goochMaterial, 0.03, 2, 0, -2, 0, 0, 0);
 loadOBJ(Part.CROSS,'obj/armadillo.obj', goochMaterial, 1, -4, 1, 2, 0, -2, 0);
 loadOBJ(Part.CROSS,'obj/car.obj', crossMaterial, 0.05, -5, 0, -4, -Math.PI/2,0,Math.PI/3);

cross.sphere = new THREE.SphereGeometry(1, 16, 16);
cross.npr_cross = new THREE.Mesh(cross.sphere, crossMaterial);
cross.npr_cross.position.set(0, 1, 1);
scenes[Part.CROSS].add(cross.npr_cross);
